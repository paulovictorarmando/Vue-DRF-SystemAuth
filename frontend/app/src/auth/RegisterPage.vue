    ...
    <div class="flex flex-col items-center gap-4   py-25">
        ...
        <form @submit.prevent="handleRegister" class="flex flex-col gap-5">
            <div class="flex flex-col gap-2">
                ...
                <input class="w-lg p-2 border-b border-white focus:outline-none focus:ring-none focus:border-b-2 focus:border-b-blue-200" type="email" v-model="email" required placeholder="e-mail" autocomplete="current-email"/>
            ...
            <button class="text-2xl font-bold w-lg h-10 bg-white text-black hover:cursor-pointer hover:bg-blue-200 hover:text-3xl transition:all duration-150" type="submit">Register</button>
        </form>
    </div>
</template>